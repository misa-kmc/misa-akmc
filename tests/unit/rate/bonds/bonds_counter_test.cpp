...
// the same input case as: TEST(vac_rate_test_src_1nn_neighbour, vac_rates_solver_tests)
...
// exchange atom of src and tar in the above test case: bonds_counter_count_test_with_V.
