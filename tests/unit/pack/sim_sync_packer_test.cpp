...
TEST_F(SimSyncPackerTest, sim_sync_packer_test) {
    ...
    const auto r_x = comm::Region<comm::_type_lattice_coord>(
            meta.box_x, meta.ghost_y, meta.ghost_z,
            meta.ghost_x + meta.box_x,
    ...
    MPI_Cart_rank(kiwi::mpiUtils::global_process.comm, rank_coords_x, &rank_x); // rank (x+1,y,z)
    MPI_Cart_rank(kiwi::mpiUtils::global_process.comm, rank_coords_y, &rank_y); // rank (x,y+1,z)
    MPI_Cart_rank(kiwi::mpiUtils::global_process.comm, rank_coords_z, &rank_z); // rank (x,y+1,z)
    MPI_Cart_rank(kiwi::mpiUtils::global_process.comm, rank_coords_xy, &rank_xy); // rank (x+1,y+1,z)
    MPI_Cart_rank(kiwi::mpiUtils::global_process.comm, rank_coords_xz, &rank_xz); // rank (x+1,y,z+1)
    MPI_Cart_rank(kiwi::mpiUtils::global_process.comm, rank_coords_yz, &rank_yz); // rank (x,y+1,z+1)
    MPI_Cart_rank(kiwi::mpiUtils::global_process.comm, rank_coords_xyz, &rank_xyz); // rank (x+1,y+1,z+1)
