...
void simulation::createDomain(
    const unsigned long phase_space[comm::DIMENSION_SIZE],
...
void simulation::createLattice() {
  ...
  builder.setGlobalLatSize(_p_domain->phase_space[0], _p_domain->phase_space[1],
