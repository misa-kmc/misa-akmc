...
/**
 *
 * \brief the send directions (can only be comm::DIR_LOW and comm::DIR_HIGH) of single forward communication in x,y,z dimensions.
...
/**
 * \brief the receive directions of single forward communication in x,y,z dimensions.
 * \param sector_id sector id
