...
const unsigned long GhostPacker::sendLength (const unsigned int sector_id, const unsigned int dim,
    ...
    comm::type_region_array region = comm::fwCommSectorSendRegion(sector_id, dim,
                                                                  reinterpret_cast<const comm::_type_lattice_size *>(ghost_size),
                                                                  reinterpret_cast<const comm::_type_lattice_coord *>(split_coord), local_box_region);
...
void GhostPacker::onReceive(Lattice buffer[], const unsigned long receive_len, LatticesList *lats,
    ...
    comm::type_region_array region = comm::fwCommSectorRecvRegion(sector_id, dim,
                                                                  reinterpret_cast<const comm::_type_lattice_size *>(ghost_size),
                                                                  reinterpret_cast<const comm::_type_lattice_coord *>(split_coord), local_box_region);
